...
export const MOCK_ADMIN_NODES: AdminNodeEntry[] = [
  ...
  { id: "jp-tok-01",   region: "日本 / 东京",      asn: "AS2914 NTT",             exitIp: "129.250.0.1",     status: "online",   latencyMs: 52,  lastHeartbeat: "2026-05-14T10:00:06Z" },
  { id: "sg-sin-01",   region: "新加坡",           asn: "AS7473 Singtel",         exitIp: "165.21.0.1",      status: "online",   latencyMs: 35,  lastHeartbeat: "2026-05-14T10:00:04Z" },
  { id: "us-iad-01",   region: "美国 / 弗吉尼亚",  asn: "AS16509 AWS",            exitIp: "52.94.0.1",       status: "online",   latencyMs: 180, lastHeartbeat: "2026-05-14T10:00:07Z" },
  { id: "us-chi-01",   region: "美国 / 芝加哥",    asn: "AS3356 Lumen",           exitIp: "4.2.2.1",         status: "degraded", latencyMs: 320, lastHeartbeat: "2026-05-14T09:45:00Z" },
  { id: "de-fra-01",   region: "德国 / 法兰克福",  asn: "AS3320 Deutsche Telekom", exitIp: "80.150.0.1",     status: "online",   latencyMs: 210, lastHeartbeat: "2026-05-14T10:00:09Z" },
  { id: "gb-lon-01",   region: "英国 / 伦敦",      asn: "AS2856 BT",              exitIp: "109.159.0.1",     status: "online",   latencyMs: 195, lastHeartbeat: "2026-05-14T10:00:11Z" },
  { id: "gb-man-01",   region: "英国 / 曼彻斯特",  asn: "AS5089 Virgin Media",    exitIp: "82.25.0.1",       status: "offline",  latencyMs: 0,   lastHeartbeat: "2026-05-14T07:30:00Z" },
]
...
export function computeNodeStats(nodes: AdminNodeEntry[]) {
  ...
  const avgLatency = onlineNodes.length > 0
    ? Math.round(onlineNodes.reduce((s, n) => s + n.latencyMs, 0) / onlineNodes.length)
    : 0
  return { online, offline, degraded, avgLatency, checksToday: nodes.length * 288 }
}
