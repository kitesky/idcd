...
const MOCK: BetaInvitation[] = [
  { id: "bid_001", code: "ABC12345", email: "dev@example.com", status: "pending",  requested_by: "usr_xxx", expires_at: null, created_at: "2026-05-14T10:00:00Z" },
  { id: "bid_002", code: "XY67890Z", email: null,              status: "approved", requested_by: null,      expires_at: "2026-06-14T10:00:00Z", created_at: "2026-05-10T09:00:00Z" },
  { id: "bid_003", code: "PQRS1234", email: "alice@corp.com",  status: "used",     requested_by: null, used_by: "usr_yyy", expires_at: null, created_at: "2026-05-01T08:00:00Z" },
]
...
export default function BetaInvitationsPage() {
  const [invitations, setInvitations] = useState(MOCK)
