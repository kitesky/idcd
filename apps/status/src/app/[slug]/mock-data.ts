    ...
    events: [
      {
        ...
        title: "API 响应延迟升高",
        description:
          "2026-05-10 14:23 UTC，我们检测到 API 服务响应时间异常升高，最高延迟达到 2.3 秒。经排查为上游数据库连接池耗尽，已通过扩容连接池上限（从 100 → 500）解决，服务于 15:47 UTC 完全恢复正常。感谢您的耐心等待。",
        status: "resolved",
        createdAt: "2026-05-10T14:23:00Z",
        resolvedAt: "2026-05-10T15:47:00Z",
...
export function generateUptimeHistory(
  ...
  for (let i = 89; i >= 0; i--) {
    ...
    result.push({ date: dateStr, status, uptime })
  }
  return result
}
