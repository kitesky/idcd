...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: 'chromium-app',
      testMatch: /(app|api-key-create|monitor-list|monitor-create|monitor-lifecycle|cert-wizard|incidents-list|status-page-create|cert-dns-creds|alert-policy|alert-events|auth-lifecycle|oncall-billing-usage|settings-bugs)\.spec\.ts/,
      use: {
